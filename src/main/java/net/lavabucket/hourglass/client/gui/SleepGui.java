...
public class SleepGui {
     ...
     * @param poseStack graphics renderer
     */
     ...
     */
    public static void renderClock(Minecraft minecraft, PoseStack stack, float x, float y, float scale) {
