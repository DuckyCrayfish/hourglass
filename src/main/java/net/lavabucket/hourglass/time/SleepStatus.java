...
public class SleepStatus {
     ...
     */
    public void updatePlayerCounts(List<ServerPlayerEntity> playerList) {
        activePlayerCount = 0;
        sleepingPlayerCount = 0;
        ...
        for (ServerPlayerEntity player : playerList) {
            if (!player.isSpectator()) {
                activePlayerCount++;
                // In versions <1.17, wait until sleep timer is greater than 0 to improve
                // compatibility with other mods.
                if (player.isSleeping() && player.getSleepTimer() > 0) {
                    sleepingPlayerCount++;
                }
            }
        }
     ...
     * @param playerList  the list of players to count
     */
    public boolean update(List<ServerPlayerEntity> playerList) {
