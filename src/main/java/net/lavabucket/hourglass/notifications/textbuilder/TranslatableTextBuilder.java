...
/**
 * A {@code TextBuilder} that uses a translation key to look up the base content from the
 * local language file. The content is then formatted using Forge and Minecraft's built-in
...
public class TranslatableTextBuilder extends TextBuilder {
    ...
    /** The translation key used to look up the translated text content. */
    protected String translationKey;

    /**
     * Creates a new instance.
     * @param translationKey  the translation key used to look up the translated text content
     */
    ...
    /**
     * Bakes the variables into a new translatable text component using the translation key provided
